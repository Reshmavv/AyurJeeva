<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_viewproductdetails.aspx.cs" Inherits="main_viewproductdetails" %>
...
<html lang="en">
	<head>
		...
		<!--<script src="mastercss/themes/js/jquery.scrolltotop.js"></script>-->
		<!--[if lt IE 9]>			
			...
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
							...
							<ul>
                                <li><li><a href="MainMasterAspx.aspx">Home</a></li>	
							<li><li><a href="userlogin.aspx">Login</a></li>					
