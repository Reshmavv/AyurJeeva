...
public partial class User_viewdisease : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            cmd.CommandText = "select * from diseasedetails";
            cmd.ExecuteNonQuery();
    ...
    protected void d1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("viewdiseasedetails.aspx?id=" + e.CommandArgument.ToString());
